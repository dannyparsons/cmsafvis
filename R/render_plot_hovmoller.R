...
#' @param nc Alternatively to `visualizeVariables$file_name` you can instead specify 
#' the input as an object of class `ncdf4` (as returned from `ncdf4::nc_open`).
#' @param nc2 Alternatively to `visualizeVariables$file_name2` you can instead specify 
#' the input as an object of class `ncdf4` (as returned from `ncdf4::nc_open`).
#' 
#' @export
